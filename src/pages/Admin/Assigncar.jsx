...
function Assigncar() {
    return (
        <div className='w-100 vh-100 row px-3 '>
            ...
            <div className="row main-container d-flex  " style={{ "height": "100vh" }} >
                ...
                <div className=" col-6 d-flex justify-content-center align-items-center flex-column gap-5">
                    ...
                    ><button className='backbtn'>comfirm</button></Link>
                </div>
            </div>

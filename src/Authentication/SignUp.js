  ...
  return (
    <div className='h-screen flex flex-col sm:flex-row font-nunito'>
      ...
      <div className='w-full hidden sm:flex justify-center items-center flex-col gap-y-24' style={{ backgroundColor: "#11687b" }}>
        <h1 className="text-3xl text-white font-nunito">
          Fuel Management
        </h1>
        <img src={Image} className='img-fluid w-3/4' alt="Navigator" />
      </div>
      ...
      <div className='bg-white w-full flex justify-center items-center'>
        <div className='mx-12'>
          ...
          <div className="text-center">
            <h1 className='text-lg font-bold mb-2'>Create a New Account</h1>
